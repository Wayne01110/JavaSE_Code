...
/*
    需求：
        把E:\\itcast\\字节流复制图片。avi复制到模块目录下的 字节流复制图片。avi
    ...
    四种方法实现复制视频，并记录每种方式复制视频的时间
        1：基本字节流一次读写一个字节               共耗时1223毫秒
        2：基本字节流一次读写一个字节数组           共耗时1282毫秒
        3：字节缓冲流一次读写一个字节              共耗时6毫秒
        4：字节缓冲流一次读写一个字节数组           共耗时1毫秒
*/
